...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(r'spaceship_yellow.png')
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)
ICON = pygame.image.load(r'iconspace.ico')


RED_SPACESHIP_IMAGE = pygame.image.load(r'spaceship_red.png')
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 270)

SPACE = pygame.transform.scale(pygame.image.load(r'space.png'), (WIDTH, HEIGHT))
...
def red_handle_movement(keys_pressed, red):
    ...
    if keys_pressed[pygame.K_RIGHT] and red.x + VEL + red.width < WIDTH-10:  # right
        red.x += VEL
    if keys_pressed[pygame.K_UP] and red.y - VEL +5> 0:  # up
        red.y -= VEL
